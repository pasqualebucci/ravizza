...
use App\Filament\Clusters\CamiciaUomo\Resources\CuffResource\Pages;
use App\Filament\Clusters\CamiciaUomo\Resources\CuffResource\RelationManagers;
use App\Models\Cuff;
use Filament\Forms;
...
class CuffResource extends Resource
{
    use Translatable;
    protected static ?string $model = Cuff::class;
    ...
    protected static ?string $navigationLabel = 'Polsini';
    ...
    {
        return [
            'index' => Pages\ListCuffs::route('/'),
            'edit' => Pages\EditCuff::route('/{record}/edit'),
        ];
    }
}
