<!-- Navbar Start -->
<nav id="navbar" class="navbar fixed top-0 start-0 end-0 z-50 transition-all duration-300 py-5 items-center bg-white lg:bg-transparent">
    <div class="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-wrap lg:flex-nowrap items-center">

            <!-- LOGO -->
            <a href="/" id="logo-white" class="flex items-center">
                <img src="{{ asset('images/logo/shirtly_white.svg') }}" class="h-9" alt="Logo White">
            </a>
            <a href="/" id="logo-dark" class="flex items-center hidden">
            ...
            <div id="navbarCollapse" class="navigation hs-collapse transition-all duration-300 lg:flex lg:items-center basis-full grow hidden mt-6 lg:mt-0">
                <ul class="navbar-nav flex flex-col lg:flex-row gap-2 lg:gap-3 justify-center mx-auto" id="navbar-navlist">
                    <li><a href="#home" class="nav-link text-sm lg:text-base font-medium px-2 py-0.5 capitalize hover:text-purple-600 transition-all">Home</a></li>
