...
<div class="h-96 mt-12 ">
      ...
      <gmp-advanced-marker position="45.49833679199219,9.141593933105469" title="My location"></gmp-advanced-marker>
    </gmp-map>
</div>
            ...
            <div class="grid lg:grid-cols-3 gap-6 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl/tight font-semibold mt-4">Hai bisogno di informazioni?<br /><span
                            class="text-[#646b2c]">Siamo
                            qui per te.</span></h2>



                    <div class="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-start mt-10">
                        <div class="h-12 w-12 rounded-full bg-[#646b2c]/10 flex items-center justify-center">
                            <x-heroicon-o-phone class="h-7 text-[#646b2c]" />
                        </div>
                        <div>
                            <h5 class="text-base text-muted font-medium mb-1">(+39) +39 333 80 28 502</h5>
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-5 text-center sm:text-start mt-10">
                        ...
                        <div>
                            <h5 class="text-base text-muted font-medium mb-1">(+39) +39 02 85 68 7613</h5>
                            <a href="#" class="text-xs text-[#646b2c] font-bold uppercase">Chiamaci</a>
                        </div>
                    </div>
                </div>
